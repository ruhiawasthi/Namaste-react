...
//passing the props- properties [passing the data into my functional component]
//sending a data from parent to child if Body is parent then RestaurantCard is the child
const Body = () => {
  return (
...
//   return (
//     <div className="card">
//     <img  alt="food" src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/533d5ee221cb729dcf42faeb8761f57d"/>
//     <h2>Burger King</h2>
//     <h3>400</h3>
//     <h3>4 star</h3>
//   </div>
